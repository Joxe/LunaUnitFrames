...
SML:Register(SML.MediaType.FONT, "Luna", "Interface\\AddOns\\LunaUnitFrames\\media\\fonts\\Luna.ttf")
...
SML:Register(SML.MediaType.STATUSBAR, "Luna", "Interface\\AddOns\\LunaUnitFrames\\media\\textures\\bars\\Luna")
